<?php
/**
 * Simple AJAX Contact Form for AnonBlog
 */
    ...
    'hooks' => [
        'render_content' => function($content) {
            if (strpos($content, '[contact]') !== false) {
                $form = '
                <div id="anon-contact-form" style="max-width: 500px; margin: 20px 0; background: rgba(128,128,128,0.05); padding: 25px; border-radius: 8px; border: 1px solid rgba(128,128,128,0.1);">
                    ...
                    <form onsubmit="sendAnonContact(event)">
