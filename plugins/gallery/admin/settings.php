        ...
        <div class="card">
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <select name="layout">
                        <option value="grid" <?php echo ($gallery_options['layout'] ?? 'grid') == 'grid' ? 'selected' : ''; ?>>Responsive Grid</option>
                        <option value="slider" <?php echo ($gallery_options['layout'] ?? '') == 'slider' ? 'selected' : ''; ?>>Horizontal Slider (Arrows)</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="columns">
                        <option value="2" <?php echo ($gallery_options['columns'] ?? 3) == 2 ? 'selected' : ''; ?>>2 Columns</option>
                        <option value="3" <?php echo ($gallery_options['columns'] ?? 3) == 3 ? 'selected' : ''; ?>>3 Columns</option>
                        <option value="4" <?php echo ($gallery_options['columns'] ?? 3) == 4 ? 'selected' : ''; ?>>4 Columns</option>
                        <option value="5" <?php echo ($gallery_options['columns'] ?? 3) == 5 ? 'selected' : ''; ?>>5 Columns</option>
                    </select>
                </div>

                <div class="form-group">
                    <label>Gap between images (Pixels)</label>
                    <input type="number" name="gap" value="<?php echo $gallery_options['gap'] ?? 15; ?>">
                </div>

                <div class="form-group">
                    <label>Border Radius (Pixels)</label>
                    <input type="number" name="border_radius" value="<?php echo $gallery_options['border_radius'] ?? 8; ?>">
                </div>

                <div class="form-group">
                    <label><input type="checkbox" name="click_to_zoom" <?php echo ($gallery_options['click_to_zoom'] ?? true) ? 'checked' : ''; ?>> Enable click to view full image</label>
                </div>
